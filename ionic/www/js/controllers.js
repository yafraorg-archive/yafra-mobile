 ...
 * under the License.
 */
var YafraController = angular.module('YafraApp.controllers', []);


/**
 * Default controller
 */
YafraController.controller('DefaultCtrl', function ($scope) {
	'use strict';
});
 ...
 */
YafraController.controller('HelpCtrl', ['$scope', 'appversion', 'SysMsg', 'yafrawiki', function ($scope, appversion, SysMsg, yafrawiki) {
